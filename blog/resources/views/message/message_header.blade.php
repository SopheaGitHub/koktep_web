<div>
    <ul class="nav nav-pills" style="margin:0px; padding:0px;">
        ...
        <li role="presentation" class="enabled"><a href="<?php echo $data->action_url.'&amp;load=inbox'; ?>"><i class="fa fa-btn fa-inbox"></i><?php echo trans('message.inbox'); ?> <?php echo (($data->message_inbox->total>0)? '<span style="background: #91beb1; padding:0px 5px; border-radius:50%; font-size:12px; color: #fff;">'.$data->message_inbox->total.'</span>':''); ?></a></li>
        <li role="presentation" class="enabled"><a href="<?php echo $data->action_url.'&amp;load=sent'; ?>"><i class="fa fa-btn fa-send"></i><?php echo trans('message.sent'); ?> </a></li>
