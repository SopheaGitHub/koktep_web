    ...
    <div class="modal-body">
      ...
      <form role="form" class="form-horizontal" enctype="multipart/form-data" id="popup-form-compose-message">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-12"><input type="text" name="search" class="form-control" placeholder="Receiver"></div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-12"><input type="text" name="subject" class="form-control" placeholder="subject"></div>
        </div>
        <div class="form-group">
