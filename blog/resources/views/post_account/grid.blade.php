            ...
            foreach ($data->posts as $post) {
                ...
                <div class="col-sm-4 col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div>
                                <span><a href="<?php echo $data->overview_account.'?account_id='.$post->author_id; ?>"><img style="width:40px; 5px solid rgba(255,255,255,0.5); border-radius:50%;" src="<?php echo ((isset($data->thumb_user[$post->post_id]))? $data->thumb_user[$post->post_id]:''); ?>"></a></span> &nbsp; 
                                <!-- <a href="<?php // echo $data->overview_account.'?account_id='.$post->author_id; ?>"> <b><?php // echo $post->author_name; ?></b></a> -->
                            </div>
                        </div>
                        <div class="col-md-8">
