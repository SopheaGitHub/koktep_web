...
<div class="w3-main w3-content" style="max-width:1600px;margin-top:83px">
  ...
  <div class="w3-row w3-grayscale-min">
    <div class="w3-quarter">
      <img src="<?php echo url('/images/photo/girl.jpg'); ?>" style="width:100%" onclick="onClick(this)" alt="Canoeing again">
      <img src="<?php echo url('/images/photo/boy.jpg'); ?>" style="width:100%" onclick="onClick(this)" alt="Quiet day at the beach. Cold, but beautiful">
      <img src="<?php echo url('/images/photo/girl.jpg'); ?>" style="width:100%" onclick="onClick(this)" alt="The Beach. Me. Alone. Beautiful">
   </div>
    
   <div class="w3-quarter">
      <img src="<?php echo url('/images/photo/girl_train.jpg'); ?>" style="width:100%" onclick="onClick(this)" alt="A girl, and a train passing">
      <img src="<?php echo url('/images/photo/man_bench.jpg'); ?>" style="width:100%" onclick="onClick(this)" alt="Waiting for the bus in the desert">
      <img src="<?php echo url('/images/photo/natureboy.jpg'); ?>" style="width:100%" onclick="onClick(this)" alt="Nature again.. At its finest!">
    </div>
    
    <div class="w3-quarter">
      <img src="<?php echo url('/images/photo/man_bench.jpg'); ?>" style="width:100%" onclick="onClick(this)" alt="Waiting for the bus in the desert">
      <img src="<?php echo url('/images/photo/girl_mountain.jpg'); ?>" style="width:100%" onclick="onClick(this)" alt="What a beautiful scenery this sunset">
      <img src="<?php echo url('/images/photo/closegirl.jpg'); ?>" style="width:100%" onclick="onClick(this)" alt="The Beach. Me. Alone. Beautiful">
    </div>

    <div class="w3-quarter">
      <img src="<?php echo url('/images/photo/natureboy.jpg'); ?>" style="width:100%" onclick="onClick(this)" alt="A boy surrounded by beautiful nature">
      <img src="<?php echo url('/images/photo/girl_train.jpg'); ?>" style="width:100%" onclick="onClick(this)" alt="A girl, and a train passing">
      <img src="<?php echo url('/images/photo/boy.jpg'); ?>" style="width:100%" onclick="onClick(this)" alt="Quiet day at the beach. Cold, but beautiful">
    </div>
  </div>
  ...
  <div class="w3-container w3-dark-grey w3-center w3-text-light-grey w3-padding-32" id="about">
    <h4><b>About Me</b></h4>
    <img src="<?php echo url('/images/photo/'); ?>avatar_hat.jpg" alt="Me" class="w3-image w3-padding-32" width="600" height="650">
      ...
      <div class="w3-third">
        ...
        <ul class="w3-ul">
          <li class="w3-padding-16 w3-hover-black">
            <img src="<?php echo url('/images/photo/'); ?>workshop.jpg" class="w3-left w3-margin-right" style="width:50px">
            <span class="w3-large">Lorem</span><br>
            <span>Sed mattis nunc</span>
          </li>
          <li class="w3-padding-16 w3-hover-black">
            <img src="<?php echo url('/images/photo/'); ?>gondol.jpg" class="w3-left w3-margin-right" style="width:50px">
