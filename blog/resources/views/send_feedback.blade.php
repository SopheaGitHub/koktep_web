    ...
    <div class="row profile">
        <div class="col-md-12">
            ...
            <div class="profile-content">
                <div class="row">
                    <div class="col-md-12"><h4><i class="fa fa-btn fa-comment"></i><?php echo $data->entry_title; ?></h4></div>
                </div>
                <br />
                <p><?php echo $data->text_feedback;?></p>
                <hr />
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <h4><i class="fa fa-btn fa-comment"></i><?php echo $data->entry_sendfeedback_form; ?></h4>
                        <hr />
                        <p id="message"></p>
                        <div id="load-form">
